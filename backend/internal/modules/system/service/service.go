...
type Config struct {
	MaintenanceCleanupBatchSize int
	MediaMaxBytes               int64
	MediaPrefix                 string
...
type Service interface {
	...
	RunMaintenanceCleanup(context.Context) (MaintenanceCleanupResult, error)
...
type Repository interface {
	...
	ListMediaUploadSessionsForCleanup(context.Context, time.Time, int) ([]model.MediaUploadSession, error)
...
// WarningLogger 是系统 service 内部 best-effort 流程使用的最小日志端口。
...
// WithLogger 注入 best-effort 清理和后台流程告警使用的最小日志端口。
...
var baseMenus = []model.MenuGroup{
	{
		...
		Items: []model.MenuItem{
			...
			{Code: "announcements", LabelKey: "system.menus.items.announcements.label", Icon: "megaphone", Path: "/announcements", Permission: "announcement:read", Scope: permissionScopeTenant, Mobile: true, Order: 20},
		},
	},
	{
		Code:     "identity",
		LabelKey: "system.menus.groups.identity.label",
		Order:    20,
		Items: []model.MenuItem{
			{Code: "iam", LabelKey: "system.menus.items.iam.label", Icon: "shield-check", Path: "/iam", Permission: "org:read", Scope: permissionScopePlatform, Order: 10},
			...
			{Code: "roles", LabelKey: "system.menus.items.roles.label", Icon: "shield", Path: "/roles", Permission: "role:read", Scope: permissionScopeTenant, Mobile: true, Order: 40},
			{Code: "sessions", LabelKey: "system.menus.items.sessions.label", Icon: "monitor-check", Path: "/sessions", Permission: "session:read", Scope: permissionScopeTenant, Order: 50},
			{Code: "security", LabelKey: "system.menus.items.security.label", Icon: "lock-keyhole", Path: "/security", Order: 60},
			{Code: "traffic-hijack", LabelKey: "system.menus.items.trafficHijack.label", Icon: "shield-alert", Path: "/traffic-hijack", Permission: "traffic_hijack:read", Scope: permissionScopePlatform, Order: 70},
			{Code: "api-tokens", LabelKey: "system.menus.items.apiTokens.label", Icon: "key-round", Path: "/api-tokens", Permission: "api_token:read", Scope: permissionScopeTenant, Order: 80},
		},
	},
	{
		Code:     "community",
	...
	},
	{
		...
		Items: []model.MenuItem{
			...
			{Code: "system", LabelKey: "system.menus.items.system.label", Icon: "settings", Path: "/system", Permission: "config:read", Scope: permissionScopePlatform, Order: 40},
			{Code: "design-system", LabelKey: "system.menus.items.designSystem.label", Icon: "palette", Path: "/design-system", Order: 50},
			{Code: "parameters", LabelKey: "system.menus.items.parameters.label", Icon: "sliders-horizontal", Path: "/parameters", Permission: "parameter:read", Scope: permissionScopePlatform, Order: 60},
		},
	},
	{
		Code:     "logs",
		...
		Items: []model.MenuItem{
			...
			{Code: "error-logs", LabelKey: "system.menus.items.errorLogs.label", Icon: "bug", Path: "/error-logs", Permission: "operation:read", Scope: permissionScopePlatform, Order: 40},
			{Code: "notification-outbox", LabelKey: "system.menus.items.notificationOutbox.label", Icon: "send", Path: "/notification-outbox", Permission: "notification:read", Scope: permissionScopePlatform, Order: 50},
		},
	},
	{
		Code:     "media",
