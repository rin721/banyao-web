...
`internal/modules/community` 为 `frontend/` Nuxt 视频社区提供公开社区数据接口。当前阶段覆盖首页、分类、视频列表、视频详情、弹幕读取与轻量发布、视频评论读取与轻量发布、视频级举报提交、投稿元数据待审核池、搜索、创作者资料、匿名创作者关注、视频点赞 / 收藏 / 稍后看、观看历史、社区动态流查询与轻量发布、关注动态和匿名通知收件箱。
