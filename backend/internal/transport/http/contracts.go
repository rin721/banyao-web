...
func mainHTTPContracts() []RouteContract {
	contracts := []RouteContract{
		...
		publicRoute("iam.invitation.accept", http.MethodPost, appconstants.APIPath("invitations", ":token", "accept"), "IAM 认证", "接受组织邀请", jsonType[iamhandler.AcceptInvitationRequest](), jsonType[authtypes.Principal](), pathString("token")),
		...
		platformPermissionRoute("iam.notification-outbox.list", http.MethodGet, appconstants.APIPath("iam", "notification-outbox"), "IAM 通知", "分页查询 IAM 通知投递队列", "notification:read", nil, jsonType[iamservice.NotificationOutboxPage](), queryParam("status", "string"), queryParam("kind", "string"), queryParam("recipient", "string"), queryInt("page"), queryInt("pageSize")),
...
func announcementRouteContracts() []RouteContract {
	return []RouteContract{
		publicRoute("announcements.public.list", http.MethodGet, appconstants.APIPath("public", "announcements"), "Announcements", "公开查询已发布公告", nil, jsonType[announcementmodel.PublicAnnouncementPage](), publicAnnouncementListParams()...),
		publicRoute("announcements.public.get", http.MethodGet, appconstants.APIPath("public", "announcements", ":announcementId"), "Announcements", "公开查询已发布公告详情", nil, jsonType[announcementmodel.PublicAnnouncement](), pathID("announcementId")),
		permissionRoute("announcements.list", http.MethodGet, appconstants.APIPath("announcements"), "Announcements", "分页查询公告", "announcement:read", nil, jsonType[announcementmodel.AnnouncementPage](), announcementListParams()...),
		permissionRoute("announcements.create", http.MethodPost, appconstants.APIPath("announcements"), "Announcements", "创建公告", "announcement:create", jsonType[announcementhandler.CreateAnnouncementRequest](), jsonType[announcementmodel.Announcement]()),
		permissionRoute("announcements.get", http.MethodGet, appconstants.APIPath("announcements", ":announcementId"), "Announcements", "查询公告详情", "announcement:read", nil, jsonType[announcementmodel.Announcement](), pathID("announcementId")),
		permissionRoute("announcements.update", http.MethodPatch, appconstants.APIPath("announcements", ":announcementId"), "Announcements", "更新公告", "announcement:update", jsonType[announcementhandler.UpdateAnnouncementRequest](), jsonType[announcementmodel.Announcement](), pathID("announcementId")),
		permissionRoute("announcements.publish", http.MethodPost, appconstants.APIPath("announcements", ":announcementId", "publish"), "Announcements", "发布公告", "announcement:update", nil, jsonType[announcementmodel.Announcement](), pathID("announcementId")),
		permissionRoute("announcements.archive", http.MethodPost, appconstants.APIPath("announcements", ":announcementId", "archive"), "Announcements", "归档公告", "announcement:update", nil, jsonType[announcementmodel.Announcement](), pathID("announcementId")),
		permissionRoute("announcements.delete", http.MethodDelete, appconstants.APIPath("announcements", ":announcementId"), "Announcements", "删除公告", "announcement:delete", nil, jsonType[BooleanResult](), pathID("announcementId")),
	}
}

func announcementListParams() []RouteParam {
	return []RouteParam{queryParam("keyword", "string"), queryParam("status", "string"), queryInt("page"), queryInt("pageSize"), queryDateTime("startCreatedAt"), queryDateTime("endCreatedAt")}
}
...
func communityRouteContracts() []RouteContract {
	return []RouteContract{
		publicRoute("community.auth.login", http.MethodPost, appconstants.APIPath("public", "community", "auth", "login"), "Community", "登录社区账号", jsonType[communitymodel.CommunityLoginRequest](), jsonType[communitymodel.CommunityAuthSessionSnapshot]()),
		...
		publicRoute("community.auth.session", http.MethodGet, appconstants.APIPath("public", "community", "auth", "session"), "Community", "查询社区账号会话", nil, jsonType[communitymodel.CommunityAuthSessionSnapshot]()),
		publicRoute("community.auth.signup", http.MethodPost, appconstants.APIPath("public", "community", "auth", "signup"), "Community", "注册社区账号", jsonType[communitymodel.CommunitySignupRequest](), jsonType[communitymodel.CommunitySignupResult]()),
		publicRoute("community.auth.refresh", http.MethodPost, appconstants.APIPath("public", "community", "auth", "refresh"), "Community", "无感刷新社区账号登录会话", nil, jsonType[communitymodel.CommunityAuthSessionSnapshot]()),
		...
		permissionRoute("community.accounts.list", http.MethodGet, appconstants.APIPath("community", "accounts"), "Community", "查询社区账号", "community_account:read", nil, jsonType[communitymodel.CommunityAccountPayload](), queryParam("keyword", "string"), queryParam("role", "string"), queryParam("status", "string"), queryInt("limit")),
		...
		authRoute("community.account.dynamics.update", http.MethodPatch, appconstants.APIPath("public", "community", "account", "dynamics", ":dynamicId"), "Community", "更新社区账号动态", jsonType[communitymodel.UpdateCommunityDynamicRequest](), jsonType[communitymodel.CommunityDynamicItem](), pathString("dynamicId")),
		authRoute("community.account.dynamics.delete", http.MethodDelete, appconstants.APIPath("public", "community", "account", "dynamics", ":dynamicId"), "Community", "删除社区账号动态", nil, jsonType[communitymodel.DeleteCommunityDynamicResult](), pathString("dynamicId")),
		authRoute("community.account.creators.follow-state", http.MethodGet, appconstants.APIPath("public", "community", "account", "users", ":handle", "follow-state"), "Community", "查询社区账号关注状态", nil, jsonType[communitymodel.CreatorFollowState](), pathString("handle")),
		authRoute("community.account.creators.follow", http.MethodPost, appconstants.APIPath("public", "community", "account", "users", ":handle", "follow"), "Community", "关注社区账号创作者", nil, jsonType[communitymodel.CreatorFollowState](), pathString("handle")),
		authRoute("community.account.creators.unfollow", http.MethodDelete, appconstants.APIPath("public", "community", "account", "users", ":handle", "follow"), "Community", "取消社区账号关注", nil, jsonType[communitymodel.CreatorFollowState](), pathString("handle")),
		authRoute("community.account.feed.following", http.MethodGet, appconstants.APIPath("public", "community", "account", "feed", "following"), "Community", "查询社区账号关注动态", nil, jsonType[communitymodel.FollowingFeedPayload]()),
		authRoute("community.account.library", http.MethodGet, appconstants.APIPath("public", "community", "account", "library"), "Community", "查询社区账号资料库", nil, jsonType[communitymodel.VideoLibraryPayload]()),
		authRoute("community.account.history.list", http.MethodGet, appconstants.APIPath("public", "community", "account", "history"), "Community", "查询社区账号观看历史", nil, jsonType[communitymodel.VideoHistoryPayload](), queryInt("limit")),
		authRoute("community.account.history.clear", http.MethodPost, appconstants.APIPath("public", "community", "account", "history", "clear"), "Community", "清空社区账号观看历史", nil, jsonType[communitymodel.VideoHistoryPayload]()),
		authRoute("community.account.notifications.list", http.MethodGet, appconstants.APIPath("public", "community", "account", "notifications"), "Community", "查询社区账号通知", nil, jsonType[communitymodel.CommunityNotificationPayload](), queryInt("limit")),
		...
		authRoute("community.account.videos.history.record", http.MethodPost, appconstants.APIPath("public", "community", "account", "videos", ":idOrSlug", "history"), "Community", "记录社区账号视频观看历史", jsonType[communitymodel.RecordAccountVideoHistoryRequest](), jsonType[communitymodel.VideoHistoryItem](), pathString("idOrSlug")),
		...
		authRoute("community.account.profile.get", http.MethodGet, appconstants.APIPath("public", "community", "account", "profile"), "Community", "查询当前社区账号资料", nil, jsonType[communitymodel.AccountProfileResponse]()),
		authRoute("community.account.profile.update", http.MethodPatch, appconstants.APIPath("public", "community", "account", "profile"), "Community", "更新当前社区账号昵称", jsonType[communitymodel.UpdateAccountProfileRequest](), jsonType[communitymodel.AccountProfileResponse]()),
		authRoute("community.account.creator-profile.update", http.MethodPatch, appconstants.APIPath("public", "community", "account", "creator-profile"), "Community", "更新当前创作者简介和头像", jsonType[communitymodel.UpdateAccountCreatorProfileRequest](), jsonType[communitymodel.AccountProfileResponse]()),
		authRoute("community.account.change-password", http.MethodPost, appconstants.APIPath("public", "community", "account", "change-password"), "Community", "修改当前社区账号登录密码", jsonType[communitymodel.ChangeAccountPasswordRequest](), nil),
		authRoute("community.account.sessions", http.MethodGet, appconstants.APIPath("public", "community", "account", "sessions"), "Community", "查询当前社区账号活跃设备会话", nil, jsonType[communitymodel.AccountSessionPayload]()),
		authRoute("community.account.sessions.revoke", http.MethodDelete, appconstants.APIPath("public", "community", "account", "sessions", ":sessionId"), "Community", "撤销指定的活跃会话(设备下线)", nil, jsonType[BooleanResult](), pathID("sessionId")),
		multipartAuthRoute("community.account.avatar.upload", http.MethodPost, appconstants.APIPath("public", "community", "account", "avatar", "upload"), "Community", "上传并更新当前社区账号头像", jsonType[communitymodel.AccountAvatarResult](), multipartParam("file", "string", true)),
		authRoute("community.account.avatar.delete", http.MethodDelete, appconstants.APIPath("public", "community", "account", "avatar"), "Community", "删除当前社区账号头像", nil, jsonType[communitymodel.AccountAvatarResult]()),
		multipartAuthRoute("community.account.banner.upload", http.MethodPost, appconstants.APIPath("public", "community", "account", "banner", "upload"), "Community", "上传并更新当前社区账号背景图", jsonType[communitymodel.AccountBannerResult](), multipartParam("file", "string", true)),
		authRoute("community.account.banner.delete", http.MethodDelete, appconstants.APIPath("public", "community", "account", "banner"), "Community", "删除当前社区账号背景图", nil, jsonType[communitymodel.AccountBannerResult]()),
		authRoute("community.account.submissions.get", http.MethodGet, appconstants.APIPath("public", "community", "account", "submissions", ":submissionId"), "Community", "查询当前社区账号单条投稿", nil, jsonType[communitymodel.CommunitySubmissionItem](), pathString("submissionId")),
		authRoute("community.account.submissions.delete", http.MethodDelete, appconstants.APIPath("public", "community", "account", "submissions", ":submissionId"), "Community", "删除当前社区账号投稿记录", nil, jsonType[communitymodel.DeleteCommunitySubmissionResult](), pathString("submissionId")),
		...
		publicRoute("community.dynamics.update", http.MethodPatch, appconstants.APIPath("public", "community", "dynamics", ":dynamicId"), "Community", "更新社区匿名动态", jsonType[communitymodel.UpdateCommunityDynamicRequest](), jsonType[communitymodel.CommunityDynamicItem](), pathString("dynamicId")),
		publicRoute("community.dynamics.delete", http.MethodDelete, appconstants.APIPath("public", "community", "dynamics", ":dynamicId"), "Community", "删除社区匿名动态", nil, jsonType[communitymodel.DeleteCommunityDynamicResult](), pathString("dynamicId"), queryParam("clientId", "string")),
		...
		publicRoute("community.videos.danmaku.create", http.MethodPost, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "danmaku"), "Community", "发布社区视频弹幕", jsonType[communitymodel.CreateVideoDanmakuRequest](), jsonType[communitymodel.VideoDanmakuItem](), pathString("idOrSlug")),
		publicRoute("community.videos.comments.list", http.MethodGet, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "comments"), "Community", "查询社区视频评论", nil, jsonType[communitymodel.VideoCommentPayload](), pathString("idOrSlug"), queryParam("clientId", "string"), queryParam("sort", "string"), queryInt("limit")),
		...
		publicRoute("community.videos.comments.update", http.MethodPatch, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "comments", ":commentId"), "Community", "更新社区视频评论", jsonType[communitymodel.UpdateVideoCommentRequest](), jsonType[communitymodel.VideoComment](), pathString("idOrSlug"), pathString("commentId")),
		publicRoute("community.videos.comments.delete", http.MethodDelete, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "comments", ":commentId"), "Community", "删除社区视频评论", nil, jsonType[communitymodel.DeleteVideoCommentResult](), pathString("idOrSlug"), pathString("commentId"), queryParam("clientId", "string")),
		publicRoute("community.videos.interaction-state", http.MethodGet, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "interaction-state"), "Community", "查询社区视频互动状态", nil, jsonType[communitymodel.VideoInteractionState](), pathString("idOrSlug"), queryParam("clientId", "string")),
		publicRoute("community.videos.interactions.set", http.MethodPost, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "interactions", ":kind"), "Community", "设置社区视频互动关系", jsonType[communitymodel.VideoInteractionRequest](), jsonType[communitymodel.VideoInteractionState](), pathString("idOrSlug"), pathString("kind")),
		publicRoute("community.videos.interactions.unset", http.MethodDelete, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "interactions", ":kind"), "Community", "取消社区视频互动关系", nil, jsonType[communitymodel.VideoInteractionState](), pathString("idOrSlug"), pathString("kind"), queryParam("clientId", "string")),
		publicRoute("community.videos.history.record", http.MethodPost, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "history"), "Community", "记录社区视频观看历史", jsonType[communitymodel.VideoHistoryRequest](), jsonType[communitymodel.VideoHistoryItem](), pathString("idOrSlug")),
		publicRoute("community.videos.reports.create", http.MethodPost, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "reports"), "Community", "提交社区视频举报", jsonType[communitymodel.CreateVideoReportRequest](), jsonType[communitymodel.CommunityReportReceipt](), pathString("idOrSlug")),
		publicRoute("community.notifications.list", http.MethodGet, appconstants.APIPath("public", "community", "notifications"), "Community", "查询社区匿名客户端通知", nil, jsonType[communitymodel.CommunityNotificationPayload](), queryParam("clientId", "string"), queryInt("limit")),
		publicRoute("community.notifications.read", http.MethodPost, appconstants.APIPath("public", "community", "notifications", "read"), "Community", "标记社区匿名客户端通知为已读", jsonType[communitymodel.CommunityNotificationRequest](), jsonType[communitymodel.CommunityNotificationPayload]()),
		...
		publicRoute("community.library", http.MethodGet, appconstants.APIPath("public", "community", "library"), "Community", "查询社区视频收藏与稍后看", nil, jsonType[communitymodel.VideoLibraryPayload](), queryParam("clientId", "string")),
		publicRoute("community.history.list", http.MethodGet, appconstants.APIPath("public", "community", "history"), "Community", "查询社区视频观看历史", nil, jsonType[communitymodel.VideoHistoryPayload](), queryParam("clientId", "string"), queryInt("limit")),
		publicRoute("community.history.clear", http.MethodPost, appconstants.APIPath("public", "community", "history", "clear"), "Community", "清空社区视频观看历史", jsonType[communitymodel.VideoHistoryClearRequest](), jsonType[communitymodel.VideoHistoryPayload]()),
	}
}
...
func systemRouteContracts() []RouteContract {
	return []RouteContract{
		...
		platformPermissionRoute("system.apis.sync", http.MethodPost, appconstants.APIPath("system", "apis", "sync"), "System", "同步 HTTP API 目录", "permission:sync", nil, jsonType[systemmodel.APISyncResult]()),
