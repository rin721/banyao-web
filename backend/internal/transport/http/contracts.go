...
func communityRouteContracts() []RouteContract {
	return []RouteContract{
		...
		publicRoute("community.auth.session", http.MethodGet, appconstants.APIPath("public", "community", "auth", "session"), "Community", "查询社区账号会话", nil, jsonType[iamhandler.CommunityAuthSessionSnapshot]()),
