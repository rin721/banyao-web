...
func communityRouteContracts() []RouteContract {
	return []RouteContract{
		...
		publicRoute("community.videos.comments.list", http.MethodGet, appconstants.APIPath("public", "community", "videos", ":idOrSlug", "comments"), "Community", "查询社区视频评论", nil, jsonType[communitymodel.VideoCommentPayload](), pathString("idOrSlug"), queryParam("sort", "string"), queryInt("limit")),
