...
export const API_ENDPOINTS = {
  announcements: {
    archive: (announcementId: EndpointID) =>
      `${apiV1}/announcements/${pathValue(announcementId)}/archive`,
    collection: `${apiV1}/announcements`,
    item: (announcementId: EndpointID) => `${apiV1}/announcements/${pathValue(announcementId)}`,
    publish: (announcementId: EndpointID) =>
      `${apiV1}/announcements/${pathValue(announcementId)}/publish`,
    publicCollection: `${apiV1}/public/announcements`,
    publicItem: (announcementId: EndpointID) =>
  ...
  iam: {
    ...
    notificationOutboxRetry: (outboxId: EndpointID) =>
