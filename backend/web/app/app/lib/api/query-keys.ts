export const queryKeys = {
  announcements: {
    ...
    ) => ["announcements", locale, page, pageSize, filters] as const,
    publicDetail: (locale: string, announcementId: number | string) =>
      ["announcements", "public", "detail", locale, announcementId] as const,
    publicList: (
      locale: string,
      page: number,
      pageSize: number,
    ...
    ) => ["announcements", "public", locale, page, pageSize, filters] as const,
  ...
  iam: {
    ...
    ) => ["iam", "notification-outbox", locale, page, pageSize, filters] as const,
    organizations: (
      locale: string,
      page: number,
      pageSize: number,
